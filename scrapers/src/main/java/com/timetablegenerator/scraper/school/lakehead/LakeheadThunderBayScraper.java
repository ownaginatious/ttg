...
@SchoolConfig(name = "Lakehead University Thunderbay Campus", id = "lutbc")
public class LakeheadThunderBayScraper extends Scraper {
    ...
    public Set<Term> findAvailableTerms() throws IOException {
        return this.scraper.findAvailableTerms(LakeheadScraper.Campus.THUNDERBAY);
    }
}
